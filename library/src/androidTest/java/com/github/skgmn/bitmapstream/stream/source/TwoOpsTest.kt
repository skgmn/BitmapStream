...
class TwoOpsTest : BitmapTestBase() {
    ...
    fun scaleToScaleTo() {
        ...
        val decoder = BitmapFactoryBitmapStream(source)
            .scaleTo(300, 400)
            .scaleTo(100, 200)
        assertEquals(100, decoder.size.width)
        assertEquals(200, decoder.size.height)
    ...
    fun scaleToScaleBy() {
        ...
        val decoder = BitmapFactoryBitmapStream(source)
            .scaleTo(100, 200)
            .scaleBy(1.1f, 1.2f)
        assertEquals(110, decoder.size.width)
        assertEquals(240, decoder.size.height)
    ...
    fun scaleToRegion() {
        ...
        assertEquals(120, decoder.size.width)
        assertEquals(130, decoder.size.height)
    ...
    fun scaleWidthScaleWidth() {
        ...
        val decoder = BitmapFactoryBitmapStream(source)
            .scaleWidth(100)
            .scaleWidth(200)
        assertEquals(byFactory.width, decoder.size.width)
        assertEquals(byFactory.height, decoder.size.height)
    ...
    fun scaleByScaleTo() {
        ...
        val decoder = BitmapFactoryBitmapStream(source)
            .scaleBy(0.7f, 0.8f)
            .scaleTo(200, 210)
        assertEquals(200, decoder.size.width)
        assertEquals(210, decoder.size.height)
    ...
    fun regionRegion() {
        ...
        assertEquals(30, decoder.size.width)
        assertEquals(40, decoder.size.height)
